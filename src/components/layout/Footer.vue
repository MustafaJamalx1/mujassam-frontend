  ...
  <footer class="bg-gray-900 text-gray-300">
    <div class="container-app py-12">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-1">
          <div class="flex items-center space-x-2 mb-4">
            ...
            <span class="font-display font-bold text-xl text-white">Mujassam</span>
          </div>
          <p class="text-sm text-gray-400 mb-4">
            Your premier destination for 3D printing services. Quality prints, custom designs, and exceptional service.
          </p>
          <!-- Social links -->
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li v-for="link in footerLinks.company" :key="link.name">
              <RouterLink :to="link.path" class="text-sm hover:text-white transition-colors">
                {{ link.name }}
              </RouterLink>
            </li>
          </ul>
      ...
      <div class="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
        <p>&copy; {{ currentYear }} Mujassam. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
